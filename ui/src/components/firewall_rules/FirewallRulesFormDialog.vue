  ...
  methods: {
    ...
    async create() {
      try {
        ...
        this.$store.dispatch('modals/showSnackbarError', { typeMessage: 'action', typeContent: 'firewallRuleCreating' });
      }
    },
    ...
    async edit() {
      try {
        ...
        this.$store.dispatch('modals/showSnackbarError', { typeMessage: 'action', typeContent: 'firewallRuleEditing' });
      }
    },
